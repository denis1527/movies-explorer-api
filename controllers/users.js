...
const UNAUTHORIZED_ERROR = require('../errors/customUnauthorizedError'); // 401
const NOT_FOUND_ERROR = require('../errors/customNotFoundError'); // 404
const CONFLICT_ERROR = require('../errors/customConflictError'); // 409
...
function fetchCurrentUserInfo(req, res, next) {
  const { _id } = req.user;
...
function modifyCurrentUserInfo(req, res, next) {
